...
const ModalDeleteCollaborator = () => {
    ...
    const {modalDeleteCollaborator, handleDeleteCollaborator, deleteCollaborator}=useProject()

  return (
    <Transition.Root show={modalDeleteCollaborator } as={Fragment}>
        <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={handleDeleteCollaborator }>
                            ...
                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div className='mt-2'>
                                    <p className='text-xl text-white bg-red-600 text-center h-10'>
                                        Deseas eliminar el colaborador.
                                    </p>
                                </div>
